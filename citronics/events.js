...
for (item of document.getElementsByClassName("span_class")) {
     item.addEventListener("click", (e) => {
          ...
          if (id == "dance_id") {
               document.getElementById("allcore").innerText = "Miss. Pragya bhopche [Pho.no. 9098605105] and Mr.  Arjun patidar [Pho.no.9926285954]";
          ...
          if (id == "cad_id") {
               document.getElementById("allcore").innerText = "Mr. Ritik jaiswal[Pho.no.81200 27119] & Mr. Harsh Pahadiya [Pho.no.83051 80448]";
          ...
          if (id == "switchingpuzzle_id") {
               document.getElementById("allcore").innerText = "Mr. Ritik jaiswal[Pho.81200 27119] & Mr. Harsh Pahadiya [Pho.no.83051 80448]";
          ...
          // asetis
          if (id == "jengablock_id") {
               document.getElementById("allcore").innerText = "MR. Ritik Prajapati [9977930622] and Mr. Ritik Sharma [6266190929]"
          ...
          if (id == "roborace_id") {
               document.getElementById("allcore").innerText = "Mr. Ajay bangar [Pho.no.78694 76374] & Mr. Kailash choudhary [Pho.no.95755 42300]";
          ...
          if (id == "ygt_id") {
               ...
               document.getElementById("allcore").innerText = "Mr. Jay Kumar Patidar [Pho.no.97995 75565] & Miss. Mansi Parmar [Pho.no.99933 58603]";
          }
          if (id == "d2d_id") {
               if (document.body.clientWidth < 1300) {
                    if (document.body.clientWidth < 600) {
          ...
          if (id == "pharmainovatsia_id") {
               ...
               document.getElementById("allcore").innerText = "Mr . Aman bundela [Pho.no.8962202886] ";
          ...
          if (id == "Beatthebug_id") {
               ...
               document.getElementById("allcore").innerText = `Miss Harshita Parmar [Pho.no.88710623993] & Mr. Aman Kushwa[Pho.no.79743 92752]`;
          ...
          if (id == "handleg_id") {
               ...
               document.getElementById("allcore").innerText = "Mr. Kunal gourav [Pho.no.81209 51155]";
          }
          if (id == "aeroplanetoss_id") {
               ...
               document.getElementById("allcore").innerText = "Mr. Kunal gourav [Ph.no.81209 51155]";
          }
          if (id == "pubg_id") {
